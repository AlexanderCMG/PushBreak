...
const altPassages = [
    ...
    "High above the Arctic Circle, where the winter nights stretch endlessly and silence settles like snow on the frozen earth, the sky sometimes stirs with color. It begins subtly—a faint shimmer of green on the northern horizon, as if the stars themselves are breathing. Then, with a sudden burst, the aurora borealis awakens, unfurling pink ribbons and cascading blue curtains that ripple like water in slow motion. People gather on snow-covered hills and frozen lakes, bundled against the cold, staring upward in quiet awe as the heavens themselves seem to dance.\nSome ancient cultures believed the lights were spirits crossing into the next world, their glowing forms trailing across the sky. Others thought they were fires lit by the gods, or messages written in celestial ink. In truth, these lights are born from solar winds—charged particles from the sun striking Earth’s magnetic field. As they collide with gases in the atmosphere, they emit light in bursts of purple, yellow, and green, creating one of nature’s most spectacular light shows.\nThe phenomenon can stretch across thousands of kilometers, arching high above frozen forests, icy fjords, and quiet mountain valleys. In some places, the lights shimmer silently; in others, witnesses claim they can hear a faint crackling in the air, like static whispering across the sky. Beneath the glow, snow reflects the light in surreal hues, casting white shadows and painting black tree trunks in pale color.\nPhotographers chase the aurora across Norway, Canada, and Iceland, carrying cameras and thermoses of coffee. They wait for the solar activity to spike, watching apps and monitors like weather prophets. When the moment arrives, the sky may explode in motion—orange spirals spinning overhead, blue arcs stretching from one horizon to the other, and flecks of green drifting like fireflies trapped in a dream.\nIn remote cabins, children press their noses to frosty windows, their breath fogging the glass. The aurora flickers above, as if inviting the world to pause. Inside, fires crackle and stories flow—tales of northern legends, of foxes whose tails swept the skies into flame, or of warriors whose battles still echo in the stars. The red of the flames inside mirrors the pulses of the heavens above.\nFor scientists, the aurora is a field of ongoing study—a glimpse into solar cycles and the Earth’s magnetic defenses. Satellites track space weather, and researchers gather data from far-flung observatories. But no amount of science can fully explain the feeling: the moment you step into the open, under a sky ignited by pink, green, and purple, and feel the quiet joy of being very small.\nTravelers journey thousands of miles for a chance to witness the lights. They stand in the deep cold of Lapland or the Yukon, their faces turned upward, cameras forgotten in mittened hands. Time stops. The aurora flares in a swirl of yellow, blue, and white, then fades as quickly as it came, slipping behind clouds or vanishing into the velvet sky.\nAnd when the lights are gone, what remains is the memory—a lingering echo of light and wonder. The frozen world returns to stillness, but something has changed. You walk back slowly, under stars crisp and clear, feeling the mystery settle into your bones like the cold. Somewhere in that sky of black and starlight, the aurora sleeps, waiting for its next brilliant return.",
    "In the year 2431, humanity had finally colonized the outer edges of the solar system. On the ice-covered moon of Callisto, far beyond Jupiter’s storms, a research base named Lumen Station studied magnetic anomalies that had puzzled scientists for decades. One night, as twin suns aligned beyond the gas giant’s curve, the sky above the base lit up in a stunning display of artificial aurora. But this wasn’t just a natural effect—these lights pulsed in organized patterns: green, purple, blue, repeating like a cosmic code.\nDr. Elara Voss was the first to notice the pattern wasn’t random. A specialist in xenolinguistics, she recognized elements of symmetry and repetition that hinted at language. The aurora flickered across Callisto’s sky like a message stitched into the void, framing the black dome of space with arcs of red, white, and pink. Elara worked tirelessly, her workstation glowing with translated glyphs and magnetic field maps, convinced that someone—or something—was trying to talk.\nThe base’s AI, ORION, confirmed the anomalies were not caused by solar winds. In fact, the signals originated from beneath Callisto’s frozen crust. A probe was dispatched into a subterranean ocean, where the ice cracked open to reveal swirling lights deeper than any sunlight had ever touched. The walls glimmered with yellow, green, and blue, illuminating strange formations—columns and arches carved by no known natural force.\nAs the probe descended, a pulse was detected: a low-frequency hum that resonated with the aurora above. The team watched in silence as images began forming on the probe’s data screens—geometric shapes spinning in sync with the lights. Elara saw it immediately. The patterns were instructions, diagrams that unfolded in glowing orange, purple, and white threads of light. Something intelligent was below, waiting, perhaps for eons, to be found.\nThe signal intensified, and suddenly the station itself began to vibrate. The aurora twisted into a vortex above the base, a swirling eye of black, green, and red energy. ORION’s voice crackled with static as systems went dark one by one. In the silence, a beam of light pierced the ice field and shot into the sky. Elara stepped outside, breath freezing instantly, and looked up. The lights were no longer random—they moved with intent, curling around stars, painting cosmic symbols in pink, yellow, and blue.\nThen, as quickly as it had begun, everything stopped. Power returned. The aurora faded. And the probe… was gone. No signal, no wreckage, just melted ice where it once entered. But what it left behind was a gift: a cube of smooth crystal, warm to the touch, radiating a soft white, orange, and purple glow. Inside, etched in microscopic detail, was a star map—one that pointed far beyond the known galaxy.\nThe council back on Earth was skeptical, but Elara knew the truth. This wasn’t just a message. It was an invitation. The aurora had been a doorway, the language of a species not bound by flesh, but by magnetism and light. She stared at the map, her heart racing. Beyond that map lay answers—perhaps to humanity’s origin, or its destiny.\nUnder the stars of Callisto, as the last faint strands of green, black, and blue shimmered and vanished into the sky, Elara made her decision. The ship would leave at dawn. And somewhere beyond the edges of light, the universe would speak again.",
    "In the heart of the Amazon Rainforest, where sunlight barely pierces the thick canopy and the air hums with life, a hidden world pulses with motion and mystery. The jungle floor is damp and warm, carpeted with decaying leaves and vibrant mosses, and every inch teems with organisms great and small. From the tangled roots to the highest branches, the forest breathes in colors—green vines coil around ancient trunks, and yellow butterflies flit through beams of morning light while the echo of a howler monkey rolls through the trees like thunder.\nA scarlet macaw bursts from a perch in a flash of red, its wings slicing the humid air. Below, a jaguar pads silently between shadows, its rosettes vanishing into the dappled light. The trees above host entire worlds—orchids blooming in clusters of pink, bromeliads collecting water in their cups, and insects shimmering in iridescent blue. Life here is layered, interconnected, and fierce in its beauty.\nFurther in, along a slow-moving river that winds like a dark ribbon through the forest, giant lily pads float in silence. Their surfaces glisten with dew, reflecting the white glow of the overcast sky. A caiman watches from the shallows, its scales a mosaic of black and green, almost invisible among the reeds. Somewhere nearby, a sloth blinks slowly as a trio of colorful frogs—orange, purple, and yellow—climb a branch like tiny painted jewels.\nThe rain comes fast and hard. Thick drops hammer the canopy in a chaotic rhythm, releasing scents of wet earth and fruit. As the storm passes, steam begins to rise, and the forest glows with renewed life. Vines sparkle with droplets that catch the fading light in every hue: blue shadows, pink glints, and golden orange halos that wrap the world in a humid shimmer. Birds call to one another, and cicadas begin their rising chorus.\nA tribe living deep within the forest moves silently through the trees, their presence gentle and light. Their clothing blends with the tones of the forest—green, brown, and black—and their stories are passed from voice to voice under the shelter of palms. Around the fire, flames crackle in bursts of red, white, and yellow, casting flickering shadows against bark and bone. They speak of spirits that live in the trees and rivers, protectors of the old forest who speak in rustles and echoes.\nAt night, the rainforest changes. Bioluminescent fungi glow faintly on the trunks of trees, painting the darkness with soft purple, blue, and green. Fireflies drift through the air like embers that forgot to fall. Somewhere in the darkness, eyes gleam—a puma, perhaps, or something less known. The forest no longer welcomes strangers after dark, only those who know how to move as part of it.\nHigh above, the canopy whispers in the wind, leaves shimmering in layers of yellow, pink, and white. Monkeys leap from branch to branch, while night birds sing strange songs into the sky. The stars blink faintly overhead, filtered through a ceiling of ancient growth. Everything is alive, watching, breathing—timeless and vast.\nAt dawn, mist clings to the forest like a secret. A black river coils through the trees, reflecting the first light of morning. The cries of parrots and the hum of insects begin again, and the jungle awakens with slow, deliberate motion. The Amazon is no place for stillness—it thrives in cycles, bursting with green, pulsing with orange, and hiding, always, something just beyond the reach of sight.",
    "Beneath the surface of Antarctica’s ice, far from sunlight and sound, lies a vast subglacial lake called Lake Vostok—a body of water untouched for millions of years. Locked beneath nearly four kilometers of ice, it remains liquid due to geothermal heat and the crushing pressure of the glacier above. Scientists have long wondered what might live in this hidden abyss. When the drill finally broke through, the first thing it touched was not water—but light. The ice cracked open with a shimmer of blue, a pulse of white, and a swirl of green unlike anything seen before.\nThe cameras descended slowly, their lights flickering in the darkness, revealing shapes that shimmered and moved. Strange organisms floated past the lens—translucent, flowing, trailing tendrils of pink, yellow, and orange. They seemed almost to dance in response to the light, gathering in delicate spirals. No one on the surface spoke; the silence in the research station was heavy, broken only by the sound of the data stream ticking upward.\nOne creature approached the camera directly. It resembled a jellyfish but with crystalline structures embedded in its form. As it moved, it refracted the light in a spectrum of shifting purple, blue, and red, as if wearing a living prism. It blinked—no, pulsed—and the readings spiked. Radiation levels changed. Magnetic fields twisted slightly. The lake was not just a habitat; it was a system, maybe even a consciousness.\nBack at the lab, the readings didn’t make sense. Patterns in the movement of the creatures resembled prime number sequences. Others matched fractal geometries and even symbols from ancient languages. Something was communicating—perhaps not with intent, but through presence. The water glowed faintly with energy: green, black, and white, soft as breath, steady as heartbeat.\nThen something changed. The creatures began to converge below the drill site, gathering in spirals. The light intensified. The camera feed dimmed, glitched, and finally returned with a single, static image: the ice walls of the lake now carved with massive, swirling glyphs. They pulsed slowly, in time with a hum rising through the ground, deep and low, almost like a voice.\nOutside, a storm began to form over the station—despite clear skies just hours before. Snow whirled in sudden torrents, the sky shaded in bands of red, gray, and blue. Instruments froze. Static filled every screen. The researchers stood at the observation window as the ice field cracked open in a perfect circle and a beam of white, yellow, and purple light shot skyward, vanishing into the clouds.\nWhen the storm passed, the lake had resealed. The creatures were gone. The beam left no trace, except for a ring of scorched snow, steaming and glowing faintly with residual energy. Inside the lab, a single crystal sat atop the control panel—left, somehow, by something no one saw. It was warm. It pulsed with orange, black, and pink light, steady and silent.\nTo this day, no one knows if what they found was life, intelligence, or the remnants of something far older than thought possible. But under Antarctica’s frozen heart, something had stirred. Something ancient, bright, and watching. And in its wake, it left only wonder—and the quiet promise that we are not alone.",
    "On the golden savannas of the Serengeti, where the grass ripples like ocean waves beneath a burning sun, a pride of lions moves through the tall brush with practiced grace. Their fur blends with the earth, a tapestry of yellow and brown, broken only by the occasional shimmer of black across a mane or tail tip. The leader of the pride, a towering male with a mane that catches the light in streaks of red, surveys the horizon with ancient patience, his breath calm, his eyes sharp.\nNearby, lionesses stalk through the underbrush, their bodies low and fluid, muscles rippling beneath orange coats that glow softly in the late afternoon light. A cub tumbles after its mother, kicking up dust that floats in the air like white motes. The sky stretches wide and cloudless, the endless dome of blue mirroring the stillness before the hunt. A herd of wildebeest grazes not far off, unaware of the eyes watching them from the shadows.\nAs twilight descends, the air grows cooler, and the lions begin to move. With a signal too subtle for human eyes, they fan out in practiced formation. The grass glows softly in the last rays of sun, catching hints of pink and gold as it brushes against their sides. The silence is broken only by the rustle of leaves and the whisper of padded feet. One lioness crouches low, her form outlined by a fading band of purple light at the horizon.\nThen, like a storm released, they strike. Dust explodes upward in bursts of brown, yellow, and black as the pride closes in. A chorus of snarls and hooves fills the air. The chase is brief but fierce. A single wildebeest stumbles, its legs folding as two lionesses converge. The male watches from a distance, his mane tossed by the wind, catching threads of red, orange, and blue as he slowly approaches the feast.\nUnder the cover of night, the pride feeds. Stars blink above, scattered across the sky in delicate patterns, shining faintly through a haze of white and purple. The cubs play near the edge of the kill, pouncing and growling in mock battle. One chews on a scrap of hide, its face smeared with pink, sticky from the meal. The adults remain calm, their bellies full, their ears twitching at distant sounds carried on the breeze.\nIn the morning, the savanna stirs again. Vultures circle in slow arcs, wings flashing black against the blue sky. The lions lounge in the shade of an acacia tree, their bodies stretched out across the warm soil. A breeze passes, ruffling fur and leaves alike. The cubs nap curled against one another, tails flicking in dreams. The green of the distant plains flickers in the heat, hiding the slow approach of new prey.\nThe lions are more than hunters—they are a force of the land itself. Their presence shapes the movement of herds, the lives of other predators, and the balance of the wild. In their eyes lies something ancient and knowing, a gaze that has watched the sunrise for countless generations. Each scar, each yawn, each growl echoes the rhythm of the Earth—sometimes fierce, sometimes still.\nAnd as the sun sets again, bleeding orange, red, and pink into the sky, the pride rises once more. Their silhouettes stretch across the savanna like shadows of gods. With every step, they remind the world that they are not merely animals, but monarchs of a realm where survival is art, and power wears a mane.",
    "Linux began as a spark of rebellion—a kernel created by Linus Torvalds in 1991 that would grow into a vast, thriving ecosystem. At its core, the system pulses with green lines of code flowing through terminals bathed in black, while the steady hum of servers running distributions painted in white echoes around the globe. From the smallest Raspberry Pi nestled in a hobbyist’s desk to the massive data centers powering the internet, Linux’s reach is vast and diverse.\nDevelopers worldwide contribute to its open-source heart, crafting tools and programs with bursts of creativity shown in orange scripts and purple interfaces. The command line glows softly with blue prompts, inviting users to explore and build. Communities form around shared passions, languages, and philosophies—spaces alive with discussion, collaboration, and innovation.\nEvery distribution brings a new flavor: Ubuntu’s friendly yellow welcoming beginners, Fedora’s cutting-edge red pushing boundaries, and Arch’s sleek black appealing to those who prefer total control. Beneath their varied surfaces lies a common thread—freedom to modify, learn, and create. The terminal windows flicker with white, revealing secrets and solutions one command at a time.\nAt data centers, Linux runs silently and reliably, orchestrating services with precision. Its kernel, lean and powerful, handles hardware from the humblest green circuit boards to the most complex blue processors. Systems administrators monitor logs glowing in soft pink, debugging issues and optimizing performance. The power of Linux lies in its transparency and adaptability, shaping the backbone of countless technologies.\nOn desktops and laptops, Linux offers choice—hundreds of graphical environments splash color across screens: deep purple themes, crisp white fonts, and vibrant orange icons that turn computing into art. Users customize endlessly, tailoring their workflows with tools that sparkle with red efficiency and yellow speed. The freedom to tweak extends to security, privacy, and control—values woven into Linux’s DNA.\nEmbedded in everything from smart TVs to spacecraft, Linux’s influence stretches beyond imagination. It runs with quiet black resilience in environments hostile to failure, where every bit of code must be perfect. Scientists, engineers, and creators depend on it for research, exploration, and invention. The kernel’s heartbeat pulses steady, echoing in every corner of a digital universe painted with green, blue, and white.\nThe story of Linux is ongoing—a journey of collaboration and curiosity, challenge and triumph. It is a testament to what a community can build when barriers fall and ideas flow freely. Around campfires and conference halls, voices rise in celebration, sharing stories framed in glowing pink, bold red, and hopeful yellow. Each line of code is a step forward, each user a guardian of an ever-evolving legacy.\nAnd as new generations discover the power within the open source, the flame of Linux burns brighter—lighting paths through the darkest code and the wildest dreams. It is more than an operating system. It is a movement, a revolution painted in orange, green, and purple, forever changing the way the world computes.",
    "In the bustling streets of Seoul, neon lights blaze in red, blue, and white, casting vibrant reflections on the sleek glass of skyscrapers that reach toward the sky like the peaks of distant mountains. The city hums with energy, a blend of ancient traditions and cutting-edge technology. Here, centuries-old palaces stand quietly amid the flow of yellow taxis and the chatter of crowds moving through markets brimming with spices and street food sizzling in pans.\nSouth Korea’s landscape is a tapestry of contrasts, where lush green mountains cradle tranquil temples adorned in orange and pink. The scent of cherry blossoms drifts through the air in spring, painting parks with delicate petals that flutter like soft purple confetti. Along the coasts, fishermen haul nets under skies brushed with hues of white and black, the ocean shimmering with hints of blue and green.\nThe culture pulses with creativity, from K-pop stages bursting with red and yellow lights to traditional hanbok robes in bold shades of purple and orange. Cafés blend minimalist design in white and black with cozy touches of pink, offering spaces where young artists and entrepreneurs sketch futures in notebooks and laptops. The streets resonate with the beats of modern music intertwined with the rhythm of centuries-old drums.\nInnovation drives the nation forward. Electronics giants glow in corporate hues of blue, white, and green, their products shaping lives around the world. Seoul’s subway trains streak by in flashes of red and yellow, ferrying millions through tunnels lit with bright orange and cool purple LEDs. Smart cities arise with sustainable energy painted in hopeful green, transforming urban spaces into vibrant, connected ecosystems.\nEducation and technology intertwine deeply, fostering a culture of excellence and curiosity. Universities shine with the glow of knowledge—campuses alive with spirited debates and research breakthroughs marked in white, blue, and red. Scientists work tirelessly in labs bathed in soft yellow and pink, developing technologies that push the boundaries of AI, robotics, and biotechnology, weaving the future into the present.\nTraditional festivals burst with color, filling streets and hearts alike. Lanterns in orange, red, and purple illuminate night skies during celebrations, while dancers in costumes rich with green and black tell stories passed down through generations. Food markets explode with the fiery reds of kimchi, the golden yellows of rice cakes, and the fresh greens of herbs, offering flavors that mirror the country’s vibrant spirit.\nBeyond the cities, the countryside reveals quiet beauty—rice paddies shimmering in yellow and green under a soft blue sky, and ancient forests cloaked in mist with shadows of black and white. Coastal cliffs rise sharply, edged by waves tinged with pink foam at dawn. These landscapes hold the soul of the nation, grounding its fast pace in timeless harmony.\nAs night falls, the cityscape transforms again. Neon signs flicker in bold red, blue, and purple, while the Han River glistens with reflections of orange and yellow lights from bridges and boats. The rhythm of life slows but never stops, carrying the heartbeat of South Korea—a nation where tradition and innovation dance together in a vivid spectrum of color and sound.",
]
...
const colorWords = [
    ...
    'sapphire', 'cobalt', 'navy', 'violet', 'magenta', 'rose', 'turquoise',
...
async function endSession() {
    ...
    if (alternate && currentSession < 13) {
        startBreak();
    } else if (currentSession <6) {
        startBreak();
    } else {
        showCompletion();
    }
